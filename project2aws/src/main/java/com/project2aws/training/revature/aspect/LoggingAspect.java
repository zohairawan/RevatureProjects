...
public class LoggingAspect {
    ...
    @Before("execution(* com.project2aws.training.revature.services.ItemServiceImpl.*(..))")
    public void doItemServiceImplLog() {
        logger.info("********ItemServiceImpl INFO logging*************");
    }

    @Before("execution(* com.project2aws.training.revature.services.UserServiceImpl.*(..))")
